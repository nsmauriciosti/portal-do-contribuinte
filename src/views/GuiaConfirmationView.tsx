...
export default function GuiaConfirmationView() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 md:px-10 py-10 flex flex-col items-center gap-10 pb-32 print:p-0 print:py-0 print:my-0">
      <motion.div 
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        className="w-full max-w-[720px] bg-white rounded-3xl border border-outline-variant shadow-lg overflow-hidden flex flex-col print:border-0 print:shadow-none print:rounded-none print:max-w-none print:w-full"
      >
        {/* Success Header */}
        <div className="bg-surface-container-low p-10 border-b border-surface-gray flex flex-col items-center text-center gap-6 print:hidden">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">
                        Carnê de Pagamento - Parcela {idx + 1}/{selectedOption.installments}
                      </span>
                    </div>
                  </div>
